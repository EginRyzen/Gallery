        ...
        <div class="card">
          ...
          <div class="card-body p-0">
            <ul class="nav nav-pills flex-column">
              <li class="nav-item">
                <a href="{{ url('persetujuan') }}" class="nav-link active">
                  <i class="fas fa-inbox"></i> Inbox
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ url('historydeclined') }}" class="nav-link">
              ...
              <div class="mailbox-controls">
                ...
                <div class="float-right">
                  <div class="btn-group">
                    ...
                    <button type="submit" name="status" value="declined" class="btn btn-danger btn-sm ml-2">
                      Declined
                    </button>
                  </div>
                  <!-- /.btn-group -->
